                ...
                <div class="row" style="max-width:100%;">
                    <div class="col-sm-8">
                        <div class="imgMob mob" style="width:100%;">
                            <img src='@/assets/img/maskm.jpg' alt="">
                        </div>
                    </div>
                    <div class="col-sm-4" style="margin-top:30px;">
                        <div class="col-sm-12" style="margin-top:20px;">
                            <h1 style="font-size:60px;margin-bottom:20px;line-height:34px;">New Hair <br/> <span style="font-size:30px;margin-left:3px;">Mascara Capilar</span></h1>
                        ...
                        <div class="col-sm-4">
                            <div class="descProd">
                                <h4 style="font-family:'Oswald', sans-serif !important; color:#000 !important;">Descrição</h4>
                                    <br>
                                    <p style="color: rgb(0, 0, 0); font-family: Open Sans; font-size: 14px; font-weight: normal;text-align:justify;">Quando se trata de cabelo ressecado, as pessoas sempre pensam em hidratações complexas e caras em salões, mas, você sabia que existe outra forma de recuperar o cabelo sem gastar muito?! Com a MÁSCARA CAPILAR DE HIDRATAÇÃO INTENSA, você recupera o seu cabelo, diminuindo o frizz e com muito mais maciez, isso porque esse super lançamento contém em sua fórmula: ÓLEO DE ARGAN & COCO + RÍCINIO. Juntos esses super ingredientes garante fios saudáveis e brilhantes, para reparação profunda e controle de frizz. Hidratação profunda, recupera as pontas, maciez e saúde dos fios. Modo de usar da Máscara de hidratação Intensa: Com o cabelo limpo e úmido, aplique a Máscara de Hidratação Intensa ao todo, massageando no sentido da raiz para as pontas, deixe agir entre 3 e 5 minutos.</p>
                            </div>
                        </div><!--col-sm-4-->
...
<style lang="scss" scoped>
   ...
   .colSeguranca .col-6{
    ...
    .trintaDias{
        ...
        .product_form{
            .col-sm-8{
                background-image:url("../../assets/img/maskm.jpg");
