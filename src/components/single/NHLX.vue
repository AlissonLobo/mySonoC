                ...
                <div class="row" style="max-width:100%;">
                    <div class="col-sm-8">
                        <div class="imgMob mob" style="width:100%;">
                            <img src="@/assets/img/singles/newhair_liso_extremo.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-sm-4" style="margin-top:30px;">
                        <div class="col-sm-12" style="margin-top:20px;">
                            <h1 style="font-size:60px;margin-bottom:20px;line-height:34px;">New Hair <br/> <span style="font-size:30px;margin-left:3px;">Liso Extremo</span></h1>
                            ...
                            <div class="precos_alt">
                                <p style="color:#6b6b6b;font-size:20px;display:inline;margin:0px 20px"><s>De: R$ 139,90</s></p>
                                <p style="font-weight:bold;color:#000;font-size:20px;display:inline;margin:0px 20px;">Por: R$ 127,70</p>
                                <img class="my-3" src="@/assets/img/img-ou.png" alt="" style="display:block;margin:0 auto;">
                                <p style="color:#000;font-size:30px;text-align:center;">12x de <strong>R$ 10,64</strong> sem juros</p>
                            </div>
                        ...
                        <div class="col-sm-4">
                            <div class="descProd">
                                <h4 style="font-family:'Oswald', sans-serif !important; color:#000 !important;">Descrição</h4>
                                    <br>
                                    <p style="color: rgb(0, 0, 0); font-family: Open Sans; font-size: 14px; font-weight: normal;text-align:justify;">New Hair Caps Feminino – Liso Extremo O Liso Perfeito é um fluído termo ativado que, auxilia o crescimento capilar de dentro para fora, garantindo um efeito incrivelmente liso e duradouro, sem prejudicar fios, dando mais vida, brilho, força, hidratação e maciez aos fios. Totalmente livre de alisantes químicos, seus fios ficarão mais lisos do que nunca!</p>
                            </div>
                        </div><!--col-sm-4-->
...
<style lang="scss" scoped>
   ...
   .colSeguranca .col-6{
    ...
    .trintaDias{
        ...
        .product_form{
            .col-sm-8{
                background-image:url('../../assets/img/singles/newhair_liso_extremo.jpg');
