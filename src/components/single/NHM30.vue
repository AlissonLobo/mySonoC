<template>
      <section id="trintaDiasMasculino" class="trintaDias">
        <div class="container-fluid">
            <div class="product_form">
                <div class="row" style="max-width:100%;">
                    <div class="col-sm-8">
                        <div class="imgMob mob" style="width:100%;">
                            <img src='@/assets/img/singles/newhair_masculino_30dias.jpg' alt="">
                        </div>
                    </div>
                    <div class="col-sm-4" style="margin-top:30px;">
                        <div class="col-sm-12" style="margin-top:20px;">
                            <h1 style="font-size:60px;margin-bottom:20px;line-height:34px;">New Hair <br/> <span style="font-size:30px;margin-left:3px;">Tratamento de 30 Dias</span></h1>
...
<style lang="scss" scoped>
   ...
   .colSeguranca .col-6{
    ...
    .trintaDias{
        ...
        .product_form{
            .col-sm-8{
                background-image:url('../../assets/img/singles/newhair_masculino_30dias.jpg');
