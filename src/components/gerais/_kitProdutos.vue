                ...
                <div class="col-sm-4 order-2 order-sm-1 bloco1" id="bloco1">
                    ...
                    style="
                        ...
                        <div class="col-sm-12 colImagem my-4">
                            <img class="imgResponsive" :src="require('@/assets/sonoCaps_img/FRASCO.png')" style="width: 75%;" alt="Renova Be 1 Pote - Vitabe" id="param">
                            <div class="flag-frete">
                                <img src="@/assets/sonoCaps_img/fretegratis2.png" alt="Frete Grátis Renova Be"
                                style="
                                position:absolute;
                                top:5%;
                                left:5%;">
                        ...
                        <div class="col-sm-12">
                            ...
                            <img class="imgResponsive ico-frete" src="@/assets/renova/ico-frete-gratis.png" alt="">
                        </div><!--col-do-preço-->
                    </div><!--container--geral-->
                </div><!--bloco1-->
                    ...
                    style="
                        ...
                        <div class="relogio" style="background-color:#864ac6;margin-bottom:15px;">
                            <div class="col-12 d-flex align-items-center" style="padding:7px 0px 2px 0px;">
                                <div class="col-4 clock" style="position:relative;right:-13%;">
                                    <img src="@/assets/renova/relogio.png" alt="" style="top:-3px;position: relative;">
                                </div>
                                <div class="col-8 oferta" style="color:#fff;position:relative;left:-10%;">
                                    <p style="margin-bottom:0px;font-weight:bold;font-size:14px;">OFERTA EXPIRA EM:</p>
                                    <p class="crono" id="crono" style="margin-bottom:0px;font-size:34px;font-weight:bold;"></p>
                                </div>
                            </div>
                        </div><!--div do relógio-->
                ...
                <div class="col-sm-4 bloco3 order-3 order-sm-3" id="bloco3">
                    ...
                    style="
                        ...
                        <div class="col-sm-12">
                            ...
                            <p style="color:#8f8f8f;font-size:18px;margin-bottom:0px;">Preço promocional: <strong style="color:#000;"> R$ 348,00</strong></p>
                            <img src="@/assets/renova/img-ou.png" class="imgResponsive" alt="">
                            <p style="color:#8f8f8f;font-size:18px;margin-bottom:0px;">12x sem juros de</p>
                            <span style="color:#000;font-weight:700;font-size:45px;font-family: 'Helvetica',sans-serif;">R$ 29,00</span>
